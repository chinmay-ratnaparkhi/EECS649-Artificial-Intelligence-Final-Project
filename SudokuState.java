...
public class SudokuState {
    ...
    private List<SudokuState> children = null;
    public List<SudokuState> getChildren() {
        return children;
    }
    public void setChildren(List<SudokuState> aChildren) {
        children = aChildren;
    }
    ...
    */
    ...
    private boolean isValid(final int[][] board) {
        ...
        // NOT NECESSARY ANY MORE SINCE THE BOARD WILL 
        // ALWAYS BE 9x9.
        // I'm getting rid of this, is that okay Joe?
        // JOE : Yes.
        //
        /*
        for (int[] row : board) {
        ...
        */
        ...
        //
        int val = (int) Math.sqrt(9);
        for (int box = 0; box < 9; box++) {
            int[] sudokuBox = new int[9];
            int boxRow = box / val;
            int boxColumn = box % val;
            int indexRowOffset = boxRow * val;
            int indexColumnOffset = boxColumn * val;
            for (int index = 0; index < 9; index++) {
                sudokuBox[index] = board[indexRowOffset + (index / val)][indexColumnOffset +(index % val)];
            }
    ...
    //
    private boolean duplicationCheck(int[] data) {
